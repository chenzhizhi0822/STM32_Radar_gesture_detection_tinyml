...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_quantized"
...
#define AI_NETWORK_IN_1_HEIGHT      (90)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (90)
#define AI_NETWORK_IN_1_SIZE_BYTES  (360)
