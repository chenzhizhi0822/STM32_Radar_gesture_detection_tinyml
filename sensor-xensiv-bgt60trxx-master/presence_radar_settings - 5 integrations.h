...
#define XENSIV_BGT60TRXX_CONF_NUM_CHIRPS_PER_FRAME (5)
...
#define XENSIV_BGT60TRXX_CONF_FRAME_REPETION_TIME_S (0.0498992)
#define XENSIV_BGT60TRXX_CONF_FRAME_XFER_SIZE_WORDS (320)
